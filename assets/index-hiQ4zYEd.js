    ...
    <div class="page fade-in">
      ...
      <div class="table-container">
        <table>
          ...
          <tbody>
            ${[70,80,90,100,110,120].map(e=>{let t=l(e,30);return`<tr><td class="num">`+e+`</td><td class="num">`+t.nov+`</td><td class="num">`+t.int+`</td><td class="num">`+t.adv+`</td><td class="num">`+t.eli+`</td></tr>`}).join(``)}
          </tbody>
        </table>
      </div>
